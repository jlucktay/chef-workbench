/*
### Cloned from https://github.com/learn-chef/inspec-on-aws
*/
...
resource "aws_security_group" "ssh" {
  ...
  # SSH access from Cloudreach London office
  ingress {
    from_port   = 22
    to_port     = 22
    protocol    = "tcp"
...
resource "aws_security_group" "web" {
  ...
  # Allow inbound HTTP connection from Cloudreach London office
  ingress {
    from_port   = 80
    to_port     = 80
    protocol    = "tcp"
